...
plt.title("Q^2 = " + str(qsq2) + " GeV^2")

plt.plot(x_th, y_th, marker=marker_th, linestyle=linestyle_th, color='magenta')
plt.plot(x_exp, y_exp, marker=marker_exp, linestyle=linestyle_exp, color='blue')
